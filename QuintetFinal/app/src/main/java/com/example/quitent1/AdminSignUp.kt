...
class AdminSignUp : CommonData() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinner1 = findViewById<View>(R.id.admin_signup_branch_spinner) as Spinner
        ...
        spinner1.onItemSelectedListener = object :
            ...
            override fun onItemSelected(
                ...
                admin_sign_up_branch.text = categories[position].toString()
            }
    ...
    private fun onclick() {
        ...
        val branch = admin_sign_up_branch.text.toString().trim() { it <= ' ' }
                ...
                FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            FireStoreClass().registerAdmin(this, user, user1)
                        } else {
                            Toast.makeText(
                                this,
